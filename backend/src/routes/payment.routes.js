...
const paymentMessage = { ok: false, message: 'Too many payment requests from this device. Please try again in 15 minutes.' };
const paymentLimiter = rateLimit({
  windowMs: 15 * 60 * 1000,
  max: 10,
  handler: rateLimitHandler(paymentMessage),
